...
Halo 2.x 博客系统 - 基于 Docker Compose 的一站式部署方案，支持自动化 CI/CD 部署。

## 项目简介

本项目提供了 Halo 2.x 博客系统的完整部署方案，包含：
...
```bash
# 克隆项目
git clone https://github.com/Leewwp/ppp-blog.git
cd ppp-blog
...
# 后台: http://localhost:8090/console
```
...
├── AUTO_DEPLOYMENT.md       # 自动化部署指南
└── THEME_SETUP.md           # Joe3.0 主题配置指南
```
...
详细配置请查看：[AUTO_DEPLOYMENT.md](AUTO_DEPLOYMENT.md)
...
- [Joe3.0 主题](https://github.com/qinhua/halo-theme-joe2.0)
